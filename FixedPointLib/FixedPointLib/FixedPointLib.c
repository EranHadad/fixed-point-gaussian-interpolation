...
void compute_log_terms(_counter n_in, _counter n_out)
{
	...
	printf("computes log values to be used in fxlog function\n");
	printf("initial log value for input of Q%d, rest of the values determined by the output format Q%d\n", n_in, n_out);
